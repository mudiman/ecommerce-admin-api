...
Revision ID: ee5c955c039a
Revises: 
Create Date: 2023-10-08 15:12:45.495200
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_inventories_id'),
                    'inventories', ['id'], unique=False)
